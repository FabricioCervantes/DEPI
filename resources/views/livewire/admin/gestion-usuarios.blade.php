...
<div class="overflow-hidden shadow-xl rounded-lg ">
    <div class="w-11/12 mt-10 flex justify-between items-center gap-5 pb-5">
        <a href="javascript:history.back()" class="flex flex-col gap-5 items-center justify-center">
    ...
    @if ($usuarios->count())
        <table class="min-w-full hidden sm:block text-left text-sm font-light">
